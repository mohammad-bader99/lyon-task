...
<div id="media" class="container w-100 row">
    ...
    <div class="text-center w-50 m-auto">
        ...
        <div class="input-group my-4">
            ...
            <input type="text" aria-label="password" disabled class="form-control" name="password" value="<?=$data->shop_name;?>">
        </div>
        <div class="input-group my-4">
            <span class="input-group-text" style="width:8rem;">shop phone</span>
            <input type="text" aria-label="password" disabled class="form-control" name="password" value="<?=$data->shop_phone;?>">
        </div>
        <div class="input-group my-4">
            <span class="input-group-text" style="width:8rem;">shop location</span>
            <input type="text" aria-label="password" disabled class="form-control" name="password" value="<?=$data->shop_location;?>">
        </div>
        <div class="input-group my-4 d-flex justify-content-around">
            <a href="/update-seller-form?name=<?=$data->name;?>" class="btn btn-warning"><i class="fa-solid fa-eye"> Update user</i></a>
